  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadChildren: () =>
          import('./academic-resources/academic-resources.module').then(
            (m) => m.AcademicResourcesModule
          ),
      },
      {
      ...
      },
      {
        ...
        data: { roles: ['Docente'] },
        loadChildren: () =>
          import('./carga-horaria-docente/carga-horaria-docente.module').then(
            (m) => m.CargaHorariaDocenteModule
          ),
      },
      {
        path: 'learn',
      ...
      },
      {
        path: 'simuladores',
        loadChildren: () =>
          import('./simulators/simulators.module').then(
      ...
      },
      {
        ...
        loadChildren: () =>
          import('./metas-y-rendimiento/metas-y-rendimiento.module').then(
            (m) => m.MetasYRendimientoModule
          ),
      },
      {
        path: 'reports',
