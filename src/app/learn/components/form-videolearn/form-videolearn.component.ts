...
export class FormVideolearnComponent {
  ...
  ngOnInit() {
    ...
    this.subscriptions.push(
      ...
      this.videolearnGroupForm.valueChanges.pipe(
        ...
        console.log('ASIGNATURA...',this.videolearnGroupForm.value.idAsignatura);
        ...
        this.asignaturaEmitter.emit(this.videolearnGroupForm.value.idAsignatura);
  ...
  verifyDurationVideo() {
    ...
    this.videolearnService.verifyYtbVideoDuration(video).subscribe((res: any) => {
      ...
      this.urlValid = false;
      this.alertaVideo = "El video no es válido, solo se aceptan videos de youtube de 10 minutos o menos";
    }
    });
  }
}
